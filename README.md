...
| **8. O sistema deve fornecer uma funcionalidade de conclusão dos exercícios agendados aos alunos no respectivo dia**                                                           | O alunos consegue concluir os treinos, mas os treinos ainda não são resetados ao fim do dia ou da semana | :large_blue_circle: Feito em parte  |
